...
public class Stmt extends Node{
    ...
    public Value If_genIR() {
        ...
        if (getChildren().size() > 5) {
            ...
            BrInstruction brInstr = new BrInstruction(LLVMType.INSTR,null,IRBuilder.getInstance().getCurBasicBlock(),new Value(LLVMType.INT1,"1"),followBlock,null);
            ...
            BrInstruction brInstr2 = new BrInstruction(LLVMType.INSTR,null,IRBuilder.getInstance().getCurBasicBlock(),new Value(LLVMType.INT1,"1"),followBlock,null);
    ...
    public Value For_genIR() {
        ...
        if (t == 0) {
            ...
            BrInstruction brInstr = new BrInstruction(LLVMType.INSTR,null,IRBuilder.getInstance().getCurBasicBlock(),
                    new Value(LLVMType.INT1,"1"),condBlock,null);
            IRBuilder.getInstance().addInstr(brInstr);
            ...
            BrInstruction brInstr2 = new BrInstruction(LLVMType.INSTR,null,IRBuilder.getInstance().getCurBasicBlock(),
                    new Value(LLVMType.INT1,"1"),ForStmt2Block,null);
            IRBuilder.getInstance().addInstr(brInstr2);
        ...
        //缺少 Cond
            ...
            getChildren().get(2).genIR();
            BrInstruction brInstr = new BrInstruction(LLVMType.INSTR,null,IRBuilder.getInstance().getCurBasicBlock(),
                    new Value(LLVMType.INT1,"1"),loopBody,null);
            IRBuilder.getInstance().addInstr(brInstr);
    ...
    public Value Break_genIR() {
        //直接跳转到followBlock
        BrInstruction brInstr = new BrInstruction(LLVMType.INSTR,null,IRBuilder.getInstance().getCurBasicBlock(),
                new Value(LLVMType.INT1,"1"),IRBuilder.getInstance().getLoopFollowBlock(),null);
        IRBuilder.getInstance().addInstr(brInstr);
        return null;
    }
    ...
    public Value Continue_genIR() {
        //直接跳转到nextBlock
        BrInstruction brInstr = new BrInstruction(LLVMType.INSTR,null,IRBuilder.getInstance().getCurBasicBlock(),
                new Value(LLVMType.INT1,"1"),IRBuilder.getInstance().getLoopNextBlock(),null);
        IRBuilder.getInstance().addInstr(brInstr);
        return null;
    }
