    ...
    public Value genIR() {
        ...
        //先 alloc 然后 Store
            ...
            if (((TokenNode)getChildren().get(1)).getToken().getType() == TokenType.ASSIGN) {
                ...
                LocalVar localVar = new LocalVar(llvmType, allocaInstr.getName(),isArray,constInitVal,targetType,new ArrayList<>());
            ...
            //ConstDef -> Ident {'[' ConstExp ']'} '=' ConstInitVal
                ...
                LocalVar localVar = new LocalVar(LLVMType.LOCAL_VAL, allocaInstruction.getName(),isArray,constInitVal,targetType,initDims);
                constSymbol.setIr(localVar);
                IRBuilder.getInstance().getTableStack().peek().addSymbol(constSymbol);
            }
        }
