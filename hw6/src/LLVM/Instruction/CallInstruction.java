...
//            }
        ...
        //如果是定义函数的调用
            ...
            for (Value param : paramArrayList) {
                ...
                } else if (MipsBuilder.getInstance().getRegByValue(param) != null) {
                    Register srcReg = MipsBuilder.getInstance().getRegByValue(param);
                    //TODO
                    tempReg = srcReg;
                } else {
                ...
                //如果有返回值
                if (MipsBuilder.getInstance().getRegByValue(this) != null) {
                    Register reg = MipsBuilder.getInstance().getRegByValue(this);
