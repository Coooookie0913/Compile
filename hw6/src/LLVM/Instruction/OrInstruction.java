...
public class OrInstruction extends Instr {
    private Value operand1;
    private Value operand2;
    public OrInstruction(LLVMType llvmType, String name, BasicBlock parentBlock, Value operand1, Value operand2) {
    ...
    public String toString() {
        return this.getName() + " = or i32 " + operand1.getName() + ", " + operand2.getName();
    }
    ...
    public void toAssembly() {
        ...
        new AluAsm(AluAsm.Op.OR,targetReg,reg1,reg2);
