...
public class MipsBuilder {
    ...
    public Register getRegByValue(String value) {
        if (var2Reg == null) {
            return null;
        } else {
    ...
    public void putVar2Reg(String value,Register register) {
        var2Reg.put(value,register);
    }
    
    public void delVar2Reg(String value) {
    ...
    public void allocRegForParam(String param, Register reg) {
        if (var2Reg == null) {
            return;
        } else {
