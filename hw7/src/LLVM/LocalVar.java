...
public class LocalVar extends Value{
    ...
    private Instr alloca;
    public LocalVar(LLVMType llvmType, String name, Boolean isArray, ArrayList<Value> valueArrayList,String targetType,ArrayList<Integer> dims,Instr alloca) {
        super(llvmType, name);
